...
public class LuceneDocumentInput implements DocumentInput<Document> {
    ...
    /**
     * Adds a field via the registered {@link LuceneFieldFactory} for its type. Accepted when Lucene
     * owns at least one requested capability; metadata fields in {@link #METADATA_DOC_VALUE_TYPES} are
     * also mirrored when enabled even with an empty capability map, since lookup/recovery need their
     * doc values. Otherwise silently skipped.
     *
